...
#
# Generated by export_simulation on Wed Dec 04 10:47:59 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './batt.sh' script.
...
./batt.sh -noclean_files

For more information on the script, please type './batt.sh -help'.
