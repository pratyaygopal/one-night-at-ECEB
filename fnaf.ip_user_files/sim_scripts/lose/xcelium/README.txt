...
#
# Generated by export_simulation on Sun Dec 08 22:39:10 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './lose.sh' script.
...
./lose.sh -noclean_files

For more information on the script, please type './lose.sh -help'.
