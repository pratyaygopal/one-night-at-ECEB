...
#
# Generated by export_simulation on Wed Dec 04 13:28:31 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './nums.sh' script.
...
./nums.sh -noclean_files

For more information on the script, please type './nums.sh -help'.
