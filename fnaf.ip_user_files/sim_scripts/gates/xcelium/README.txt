...
#
# Generated by export_simulation on Tue Dec 10 17:12:31 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './gates.sh' script.
...
./gates.sh -noclean_files

For more information on the script, please type './gates.sh -help'.
