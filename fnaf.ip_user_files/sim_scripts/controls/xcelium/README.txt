...
#
# Generated by export_simulation on Thu Dec 12 15:35:43 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './controls.sh' script.

./controls.sh -reset_run
...
./controls.sh -noclean_files

For more information on the script, please type './controls.sh -help'.
