...
#
# Generated by export_simulation on Sun Dec 01 20:07:21 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './door.sh' script.
...
./door.sh -noclean_files

For more information on the script, please type './door.sh -help'.
