...
#
# Generated by export_simulation on Mon Dec 02 16:06:24 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './cams.sh' script.
...
./cams.sh -noclean_files

For more information on the script, please type './cams.sh -help'.
