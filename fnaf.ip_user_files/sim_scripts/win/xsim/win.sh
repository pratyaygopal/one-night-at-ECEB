...
#
# Generated by Vivado on Sun Dec 08 22:40:37 -0600 2024
...
# Script info
echo -e "win.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot win xil_defaultlib.win xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  win -key {Behavioral:sim_1:Functional:win} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_fnaf.protoinst" -log simulate.log
}
