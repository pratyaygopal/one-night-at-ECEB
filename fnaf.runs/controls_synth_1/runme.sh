...
HD_PWD='C:/Users/Poiku/Documents/ECE385/fnaf/fnaf.runs/controls_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controls.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controls.tcl
