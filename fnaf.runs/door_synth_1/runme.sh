...
HD_PWD='C:/Users/Poiku/Documents/ECE385/fnaf/fnaf.runs/door_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log door.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source door.tcl
