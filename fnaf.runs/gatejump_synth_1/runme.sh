...
HD_PWD='C:/Users/Poiku/Documents/ECE385/fnaf/fnaf.runs/gatejump_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gatejump.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gatejump.tcl
