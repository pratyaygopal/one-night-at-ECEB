...
HD_PWD='C:/Users/Poiku/Documents/ECE385/fnaf/fnaf.runs/batt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log batt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source batt.tcl
