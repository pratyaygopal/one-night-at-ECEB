...
HD_PWD='C:/Users/Poiku/Documents/ECE385/fnaf/fnaf.runs/lose_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lose.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lose.tcl
